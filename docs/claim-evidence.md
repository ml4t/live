...
| Maturity | IB and Alpaca brokers plus Alpaca, IB, and OKX feeds are beta-supported only at these boundaries; DataBento and generic CCXT are experimental | public claim scan, experimental-feed tests, and retained IB plus Alpaca paper bundles tied to the candidate wheel hash |
