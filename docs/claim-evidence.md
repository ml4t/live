...
| Maturity | IB and Alpaca brokers plus the OKX feed are stable-supported; Alpaca, IB, DataBento, and generic CCXT feeds require experimental opt-in | public claim scan, experimental-feed tests, retained feed evidence, and retained IB plus Alpaca paper bundles tied to the candidate wheel hash |
